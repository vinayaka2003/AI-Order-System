...
def chat():
    ...
    matches = re.findall(
        ...
        r'(\d+)\s+(banana|apple|mango|orange|grapes|pineapple|watermelon|kiwi|papaya|strawberry)s?',
    ...
    if not matches:
        ...
        return jsonify({
            ...
            ✅ Create Orders<br>
            • I want 2 bananas<br>
            • 5 apples tomorrow<br>
            • 3 mangoes at 5:30 pm<br><br>
...
def clear():
    ...
    cursor.execute("DELETE FROM quality_notes")
